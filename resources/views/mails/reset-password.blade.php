                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <div>
                                              <div style="border-radius: 8px; padding: 40px 20px; border: thin solid #dadce0;" align="center" class="m_-1986842713481294047mdv2rw">
                                                <div style="font-family: 'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif; border-bottom-width: thin; border-bottom-color: #dadce0; border-bottom-style: solid; color: rgba(0,0,0,0.87); line-height: 32px; padding-bottom: 24px; word-break: break-word;" align="center">
                                                <div style="font-size: 24px;">
                                                  Reset Password Request
                                                </div>
                                                <table align="center" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 8px auto 0;" border="0" cellpadding="0" cellspacing="0">
                                                  <tbody>
                                              ...
                                              <div style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 14px; color: rgba(0,0,0,0.87); line-height: 20px; padding-top: 20px;" align="center">
                                                We have received a request to reset your account password. Please click the button below. If this request is not from you, please ignore this email.
                                                <div style="padding-top: 32px;" align="center">
                                                  <a href="{{ $data['url_reset_password'] }}" style="font-family: 'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif; line-height: 16px; color: #ffffff; font-weight: 400; text-decoration: none; font-size: 14px; display: inline-block; background-color: #4184f3; border-radius: 5px; min-width: 90px; padding: 10px 24px;" target="_blank" data-saferedirecturl="{{ $data['url_reset_password'] }}">
                                                    Reset Password Now
                                                  </a>
                                                </div>
                                              </div>
                                          ...
                                          <div style="text-align:left">
                                            <div style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;color:rgba(0,0,0,0.54);font-size:11px;line-height:18px;padding-top:12px;text-align:center">
                                              <div>You received this email because you or someone else has registered your email in our system</div>
                                              <div style="direction:ltr">
                                                © {{ date('Y') }} Haina service Indonesia
                                              </div>
                                            </div>
                                          </div>
                                        </td>
